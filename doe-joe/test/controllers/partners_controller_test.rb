...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { curriculum: @partner.curriculum, email: @partner.email, name: @partner.name, remarks: @partner.remarks } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { curriculum: @partner.curriculum, email: @partner.email, name: @partner.name, remarks: @partner.remarks } }
